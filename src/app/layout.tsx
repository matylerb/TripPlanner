...
export const metadata: Metadata = {
  title: "TripSync — plan the trip together, then go",
  description:
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${fraunces.variable} ${geist.variable} ${geistMono.variable} h-full`} suppressHydrationWarning>
      <head>
